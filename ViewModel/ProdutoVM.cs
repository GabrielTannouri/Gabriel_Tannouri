...
namespace Pratica_Profissional.ViewModel
{
    public class ProdutoVM
    {
        public Models.Produto VM2E(Models.Produto bean)
        {
            ...
            bean.vlPrecoCusto = this.vlPrecoCusto;
            bean.vlPrecoVenda = this.vlPrecoVenda;
            ...
            bean.idCategoria = this.Categoria.idCategoria;
            bean.idFornecedor = this.Fornecedor.idFornecedor;
            return bean;
        }
