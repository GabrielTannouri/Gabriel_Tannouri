    ...
    public class DAOProduto : DAO
    {
        ...
        public bool Create(Produto produto)
        {
            try
            {
                ...
                SqlQuery.Parameters.AddWithValue("@vlPrecoCusto", produto.vlPrecoCusto);
                SqlQuery.Parameters.AddWithValue("@vlPrecoVenda", produto.vlPrecoVenda);
                SqlQuery.Parameters.AddWithValue("@vlPrecoUltCompra", produto.vlPrecoUltCompra);
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    var produto = new Produto
                    {
                        ...
                        vlPrecoCusto = Convert.ToDecimal(reader["vlprecocusto"]),
                        vlPrecoVenda = Convert.ToDecimal(reader["vlprecovenda"]),
                        vlPrecoUltCompra = Convert.ToDecimal(reader["vlprecoultcompra"]),
